...
The index of the elements corresponds to its position in the spreadsheet. Empty cells will be ignored. This means if you have for example a row with information in the first two cells, and information in the 8th cell, the array will have indexes 0 1 and 6 assigned to the cell's content.
